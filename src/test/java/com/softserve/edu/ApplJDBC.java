...
//    private static String password = "root";
    ...
    private static String URL = "jdbc:jtds:sqlserver://Roman/Lv169OMS;instance=SQLEXPRESS;";
    // MySQL
//    private static String URL = "jdbc:mysql://localhost:3306/measurement_devices";
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        //ResultSet rs = st.executeQuery("SELECT * FROM users WHERE ID = 1029;");
        //ResultSet rs = st.executeQuery("SELECT *  FROM Users;");
        //ResultSet rs = st.executeQuery("SELECT *  FROM Users WHERE Login LIKE 'iv%';");
        //st.execute("DELETE dbo.Users WHERE ID='1001561'");
        ResultSet rs = st.executeQuery("SELECT ID, *  FROM Users WHERE Login LIKE 'del%';");
        // MySQL
