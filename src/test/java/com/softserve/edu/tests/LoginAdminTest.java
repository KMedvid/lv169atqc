...
public class LoginAdminTest {
	StartData startData = new StartData("http://ssu-oms:8180/OMS/login.htm", 
			"http://ssu-oms:8180/OMS/logout.htm", "",
			"chrome", "");

	@BeforeClass
	public void oneTimeSetUp() {
		System.out.println("@BeforeClass - oneTimeSetUp");
		System.out.println("\t@BeforeClass - oneTimeSetUp, Thread Id = " + Thread.currentThread().getId());
	}
	...
	@BeforeMethod
	public void setUp() {
		System.out.println("\t@BeforeMethod - setUp, Thread Id = " + Thread.currentThread().getId());
	}
	...
	public Object[][] allUsers() {
		return new Object[][] { { UserRepository.get().getAdminUser() }, { UserRepository.get().getCustomerUser() } };
	}
