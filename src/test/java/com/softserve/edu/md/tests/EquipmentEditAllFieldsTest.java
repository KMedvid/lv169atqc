 ...
 * http://localhost:8080/employee#/calibrator/mEquipment/ test if edit of device
 * work properly when we clear all previous data and enter new data check if
 * necessary elements are present on page
 * 
 * @version 1.00
 * 
 * @author Me
...
public class EquipmentEditAllFieldsTest {
	...
	public void checkEquipmentEdit(IUser calibrator, IUrls urls) throws InterruptedException {
		...
		MeasuringEquipmentPage.MeasuringEquipmentEditPage newMeasuringEquipmentEditPage = newMeasuringEquipmentPage
				.gotoMeasuringEquipmentEditForm();
		...
		Thread.sleep(2000);
		softAssert.assertEquals(newMeasuringEquipmentEditPage.checkEdit_elements_existence(),
