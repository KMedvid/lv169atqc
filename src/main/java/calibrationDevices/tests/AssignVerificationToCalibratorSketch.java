...
public class AssignVerificationToCalibratorSketch {
    ...
    @Test(dataProvider = "verification", groups="First")
    ...
    @Test(dataProvider = "existUsers", groups="Second", dependsOnGroups="First")
    public void checkNewVerification(IUser providerUser, IUrls urls) throws InterruptedException {
    ...
    @Test(dataProvider = "existUsers",  groups="Third", dependsOnGroups="Second")
    public void checkWorkerIsAssigned(IUser existUser, IUrls urls)
    ...
    @Test(dataProvider = "existUsers",  groups="Fourth", dependsOnGroups="Third")
    public void checkAssignToCalibrator(IUser existUser, IUrls urls)
            throws InterruptedException {
        ...
        Thread.sleep(1000); // For better visual feedback
        newVerificationsPage.searchVerificationByIdCOde(verificationID);
        SendToCalibratorPage sendToCalibratorPage = newVerificationsPage.assignVerificationToCalibrator(verificationID);
        System.out.println("Assign calibrator ok");
        System.out.println("Assign send calibrator ok");
    ...
    @Test(dataProvider = "existUsers",  dependsOnGroups="Fourth")
